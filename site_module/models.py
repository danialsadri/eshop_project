...
class SiteSetting(models.Model):
    ...
    site_logo = models.ImageField(upload_to='images/site-setting/', verbose_name='لوگو')
...
class FooterLink(models.Model):
    footer_link_box = models.ForeignKey(to=FooterLinkBox, on_delete=models.CASCADE, verbose_name='دسته بندی', related_name='footerlinkes')
    title = models.CharField(max_length=200, verbose_name='عنوان')
